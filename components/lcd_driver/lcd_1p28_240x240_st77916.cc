...
esp_err_t display_panel_create_st77916(const display_panel_spi_params_t* p,
                                       ...
                                       display_panel_result_t* out)
{
    ...
    if (vendor && vendor->init_cmds && vendor->init_cmds_size > 0) {
        panel_config.vendor_config = (void*)vendor; // 调用方保证类型兼容 st77916_vendor_config_t
    }

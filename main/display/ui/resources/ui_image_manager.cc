...
static const char* IMAGE_FILES[] = {
    ...
    IMG_FILE_ICON_BATTERY_0,
    IMG_FILE_ICON_BATTERY_1,
    IMG_FILE_ICON_BATTERY_2,
    IMG_FILE_ICON_BATTERY_3,
    IMG_FILE_ICON_BATTERY_4,
    IMG_FILE_ICON_BATTERY_CHARGE,
    IMG_FILE_ICON_BELL,
    IMG_FILE_SIGNAL_WIFI,
    IMG_FILE_SIGNAL_WIFI_0,
    IMG_FILE_SIGNAL_WIFI_1,
    IMG_FILE_SIGNAL_WIFI_2,
    IMG_FILE_SIGNAL_4G,
    IMG_FILE_SIGNAL_4G_1,
    IMG_FILE_SIGNAL_4G_2,
    IMG_FILE_SIGNAL_4G_3,
    IMG_FILE_SIGNAL_4G_4,
};

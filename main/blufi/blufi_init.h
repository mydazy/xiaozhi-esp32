...
extern esp_err_t esp_blufi_controller_deinit();
extern esp_err_t
esp_blufi_host_and_cb_init(esp_blufi_callbacks_t *example_callbacks);
extern esp_err_t esp_blufi_host_deinit(void);
extern void blufi_dh_negotiate_data_handler(uint8_t *data, int len,
                                            uint8_t **output_data,
